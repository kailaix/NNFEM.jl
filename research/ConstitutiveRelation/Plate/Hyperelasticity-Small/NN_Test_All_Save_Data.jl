...
#       current is 100cm    and      10-6MPa               s  
...
function Plot(tid::Int64, restart_id::Int64)
    ...
    savefig("Plot/plate_hyperelasticity_disp_nn$(idx)_$(nntype)_from$(restart_id)_test$(tid).png")
...
function PlotStress(tid::Int64, nx::Int64, ny::Int64, nxf::Int64, nyf::Int64, fiber_size::Int64, porder::Int64, 
    ...
    savefig("Plot/plate_hyperelasticity_stress_reference$(tid).png")
    ...
    savefig("Plot/plate_hyperelasticity_stress_test_nntrain$(idx)_$(nntype)_from$(restart_id)_test$(tid).png")
    ...
    visσ(domain, nx, ny,  stress[frame-1], full_state_history[frame], vmin, vmax; scaling = scales)
    savefig("Plot/plate_hyperelasticity_stress_test_nnlearn$(idx)_$(nntype)_test$(tid).png")

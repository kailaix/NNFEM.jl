...
nn_file = "../Data/$(nntype)/nn_train_false_2_spd_Chol_Orth_from3_ite50.mat"
...
timer = @timed globdat, domain, ts = AdaptiveSolver("NewmarkSolver", globdat, domain, T, NT, adaptive_solver_args)

using DelimitedFiles
open("NN$(force_scale)$tid.txt", "a") do io 

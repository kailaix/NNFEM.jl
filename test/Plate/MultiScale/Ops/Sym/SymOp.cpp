...
public:
  explicit SymOpOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_OP("SymOpGrad")
  
  .Input("grad_y : double")
  .Input("y : double")
  .Input("x : double")
  .Output("grad_x : double");
class SymOpGradOp : public OpKernel {
private:
  
public:
  explicit SymOpGradOp(OpKernelConstruction* context) : OpKernel(context) {

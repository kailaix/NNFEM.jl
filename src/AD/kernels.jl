...
"""
function s_compute_stiffness_matrix(k::Union{Array{Float64,3}, PyObject})
...
"""
function s_eval_strain_on_gauss_points(state::Union{Array{Float64,1}, PyObject})
...
"""
function s_compute_internal_force_term(stress::Union{Array{Float64,2}, PyObject})

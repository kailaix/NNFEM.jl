...
# This file defines the Gmsh Julia API (v4.5).
#
...
const GMSH_API_VERSION = "4.5"
const GMSH_API_VERSION_MAJOR = 4
const GMSH_API_VERSION_MINOR = 5
const libdir = dirname(@__FILE__)
const libname = Sys.iswindows() ? "gmsh-4.5.dll" : (Sys.isapple() ? "libgmsh.dylib" : "libgmsh.so")
import Libdl
